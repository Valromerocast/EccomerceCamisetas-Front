# Documentación Técnica — Mundialista Store (Frontend)

Documentación técnica del frontend del e-commerce de camisetas de selecciones nacionales, desarrollado como Trabajo Práctico Obligatorio (TPO) para la materia APIS — UADE.
...
## Acceso rápido a respuestas de defensa

| Pregunta | Documento | Sección |
|---|---|---|
| ¿Con qué desarrollaron el front? | [stack-tecnologico.md](./stack-tecnologico.md) | Stack del Frontend |
...
| Circuito de agregar un producto (admin) | [circuitos.md](./circuitos.md) | Circuito de Alta de Producto |
| Circuito del descuento | [circuitos.md](./circuitos.md) | Circuito del Descuento de Envío |
| Circuito de inicio de sesión | [circuitos.md](./circuitos.md) | Circuito de Inicio de Sesión |
| Circuito de cierre de sesión | [circuitos.md](./circuitos.md) | Circuito de Cierre de Sesión |
| Preguntas técnicas de conectores | [api-interna.md](./api-interna.md) | Conectores de React Router |
| Qué hace cada función interna | [api-interna.md](./api-interna.md) | Funciones del Carrito / Autenticación / Órdenes |
| Cómo funciona el carrito enriquecido | [api-interna.md](./api-interna.md) | El Carrito Enriquecido (enrichedCart) |
